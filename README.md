...
- **`Literature_Review/`**  
  Collection of research papers, references, and notes related to batch distillation theory and experimental methods.

- **`Experiments/`**  
  Experimental data, processed datasets, observations, and results from batch distillation runs.

- **`Design/`**  
  CAD models, design sketches, schematics, and calculations related to the distillation apparatus.
...
3. Consult `Literature_Review/` for background reading and references.  
4. Check `Experiments/` for raw and processed experimental results.  
5. Explore `Design/` for apparatus design files and supporting calculations.
